...
L.MIGRATED_FROM_MACRO = "Settings migrated from the old macro backup to SavedVariables."
L.MACROS_REMOVED = "Old settings backup macros removed; settings are kept in SavedVariables."
