...
for _, want in ipairs({
    ...
    { key = "classIconY", code = "KY", default = 2, min = -64, max = 64, label = "Class icon Y" },
...
H.check("badge: default y", point(badge, "CENTER")[5], 2)
...
H.check("party: badge offset", point(member.classBadge, "CENTER")[5], 2)
