...
- Range fading: party members, their pets, your pet, the target and the focus fade while out of range (the opacity is configurable). The range is your own spell's: a heal for friends and a damage spell for enemies, picked for your class (Priest: Lesser Heal / Smite, Druid: Healing Touch / Wrath, Shaman: Healing Wave / Lightning Bolt, Paladin: Holy Light, Mage: Arcane Intellect / Fireball, Frostbolt, Warlock: Unending Breath / Shadow Bolt, Hunter: Mend Pet for your pet / Auto Shot). Any other spell can be set by name or ID under General > Status. Without a spell, group members use Blizzard's group range (~40 yards) and everyone else the ~28-yard follow distance; the target and focus then stay unfaded by default (Warrior, Rogue, and Paladin against enemies).
